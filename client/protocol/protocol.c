...
int parse_message(const char *buffer, Message *msg) {
    ...
    if (data_keyword) {
        ...
        *newline = '\0';
        ...
        char *space = strchr(tmp, ' '); // space = " param1|param2|param3" tmp = "COMMAND"
        if(space){
            *space = '\0';
            strncpy(msg->command, tmp, sizeof(msg->command) - 1);

            char *params_str = space + 1; // params_str = "param1|param2|param3"
...
int create_data_message(int code, const char *data, size_t data_len, char *buffer, size_t buffer_size) {
    ...
    if (header_len + data_len > buffer_size) return -1;
...
const char* get_code_description(int code) {
    switch(code) {
        case CODE_CREATED: return "CREATED";
        case CODE_LOGIN_OK: return "LOGIN_OK";
        case CODE_LOGOUT_OK: return "LOGOUT_OK";
        case CODE_ROOM_CREATED: return "ROOM_CREATED";
        case CODE_ROOMS_DATA: return "DATA";
        case CODE_ROOM_JOIN_OK: return "ROOM_JOIN_OK";
        case CODE_ROOM_LEAVE_OK: return "ROOM_LEAVE_OK";
        case CODE_START_OK: return "START_OK";
        case CODE_RESULT_DATA: return "DATA";
        case CODE_SUBMIT_OK: return "SUBMIT_OK";
        case CODE_ALREADY_SUBMITTED: return "ALREADY_SUBMITTED";
        case CODE_DATA: return "DATA";
        case CODE_PRACTICE_RESULT: return "PRACTICE_RESULT";
        case CODE_EXAM_DATA: return "DATA";
        case CODE_NOT_LOGGED: return "NOT_LOGGED";
        case CODE_SESSION_EXPIRED: return "SESSION_EXPIRED";
        case CODE_ROOM_NOT_FOUND: return "ROOM_NOT_FOUND";
        case CODE_ROOM_ALREADY_STARTED: return "ROOM_ALREADY_STARTED";
        case CODE_ROOM_FINISHED: return "ROOM_FINISHED";
        case CODE_NOT_CREATOR: return "NOT_CREATOR";
        case CODE_NOT_IN_ROOM: return "NOT_IN_ROOM";
        case CODE_ROOM_FULL: return "ROOM_FULL";
        case CODE_TIME_EXPIRED: return "TIME_EXPIRED";
        case CODE_BAD_COMMAND: return "BAD_COMMAND";
        case CODE_SYNTAX_ERROR: return "SYNTAX_ERROR";
        case CODE_INVALID_PARAMS: return "INVALID_PARAMS";
        case CODE_USERNAME_EXISTS: return "USERNAME_EXISTS";
        case CODE_INVALID_USERNAME: return "INVALID_USERNAME";
        case CODE_WEAK_PASSWORD: return "WEAK_PASSWORD";
        case CODE_INTERNAL_ERROR: return "INTERNAL_ERROR";
